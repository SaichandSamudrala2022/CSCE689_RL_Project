...
#class GridGraph(object): # Vasudev 12/2
class GridGraph(gym.Env):
    def __init__(self, gridParameters):
        ...
        # Vasudev 12/2
        self.my_max_cap = int(self.gridParameters['verticalCapacity'][1])
        self.my_max_x = self.gridParameters['gridSize'][0]
        self.my_max_y = self.gridParameters['gridSize'][1]
        self.my_max_z = self.gridParameters['gridSize'][2]
        self.action_space = spaces.Discrete(6)## TODO
        self.observation_space = spaces.MultiDiscrete([self.my_max_x,self.my_max_y,self.my_max_z,self.my_max_cap+1,self.my_max_cap+1,self.my_max_cap+1,self.my_max_cap+1,10+1,10+1,(2*self.my_max_x)-1,(2*self.my_max_y)-1,(2*self.my_max_z)-1])## TODO
        #print("In init")
    ...
    def reset(self):
        ...
        # Vasudev 12/2
        self.instantrewardcombo.append(self.reward)
    ...
    def state2obsv(self):
        ...
        distance = distance[:3]+ np.array([self.my_max_x-1,self.my_max_y-1,self.my_max_z-1]) # Vasudev 12/2
        #observation = np.concatenate((state[:3], capacity, distance[:3]), axis=0).reshape(1, -1)
        observation = np.concatenate((state[:2], state[2:3]-1, capacity, distance[:3]), axis=0).reshape(1, -1)
        #print("In state2obsv")
